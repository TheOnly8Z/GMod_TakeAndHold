...
TAH.ConVars["game_limitedammo"]     = CreateConVar("tah_game_limitedammo", "1", FCVAR_ARCHIVE + FCVAR_REPLICATED + FCVAR_NOTIFY, "Enable limited ammo mode, requiring players to scavenge for bullets.", 0, 1)
TAH.ConVars["game_limitedcust"]     = CreateConVar("tah_game_limitedcust", "1", FCVAR_ARCHIVE + FCVAR_REPLICATED + FCVAR_NOTIFY, "Enable limited customization mode, requiring players to apply attachment sets to their guns instead of freely setting attachments.", 0, 1)
